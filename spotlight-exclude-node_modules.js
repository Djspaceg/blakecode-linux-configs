// From: https://github.com/Strajk/setup/blob/master/programs/prevent-spotlight-from-indexing-node-modules.js
// Thread: https://github.com/yarnpkg/yarn/issues/6453

const { execSync } = require("child_process");

// Customize
// ===
// const DIR = "/Users/blake/Source" // TODO: Maybe take from args?
const DIR = "/Users/blake/Source/sim-lgsvlsimulator.com" // TODO: Maybe take from args?
...
const PASSWORD = process.env.SUDO_PASSWORD || "macsr31337" // TODO: Better security, see note about sudo-prompt

// Keep
// ===
// const PLIST = "/System/Volumes/Data/.Spotlight-V100/VolumeConfiguration.plist"
const PLIST = "/.Spotlight-V100/VolumeConfiguration.plist"
...
// Collect info
// ===
const candidates = cleanArray(execSyncSudo(`find ${DIR} -type d -name 'node_modules' -prune`))
...
console.log(`Candidates: ${candidates.length}, Existing: ${existing.length}, To add: ${toAdd.length}`, candidates)
